...
/* First created by JCasGen Thu Sep 10 11:19:06 CEST 2015 */
...
public class Number_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("es.upm.ctb.midas.talleruima.ej2.Number");
  ...
  public int getAbsoluteIntegerValue(int addr) {
      ...
      jcas.throwFeatMissing("absoluteIntegerValue", "es.upm.ctb.midas.talleruima.ej2.Number");
  ...
  public double getAbsoluteDoubleValue(int addr) {
      ...
      jcas.throwFeatMissing("absoluteDoubleValue", "es.upm.ctb.midas.talleruima.ej2.Number");
  ...
  public boolean getIsDouble(int addr) {
      ...
      jcas.throwFeatMissing("isDouble", "es.upm.ctb.midas.talleruima.ej2.Number");
  ...
  public int getSign(int addr) {
      ...
      jcas.throwFeatMissing("sign", "es.upm.ctb.midas.talleruima.ej2.Number");
